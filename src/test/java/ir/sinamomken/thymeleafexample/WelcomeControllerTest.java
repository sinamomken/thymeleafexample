package ir.sinamomken.thymeleafexample;

import ir.sinamomken.thymeleafexample.controller.WelcomeController;
...
public class WelcomeControllerTest {
    ...
    public void main() throws Exception{
        ResultActions resultActions = mockMvc.perform(get("/"))
                ...
                .andExpect(model().attribute("message", equalTo("Sina Momken")))
                .andExpect(model().attribute("tasks", is(expectedList)))
                .andExpect(content().string(containsString("Hello, Sina Momken")));
